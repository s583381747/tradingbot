"""
Chop-Box Trend-Following Strategy — Gen 5 (aggressive loss cutting).
...
INITIAL_STOP_ATR_MULT = 1.5     # Gen 5: tight stop — cut losers fast
...
# Time-Based Exit
LOSERS_MAX_BARS = 20            # Gen 5: aggressive — if not working in 20 min, get out
