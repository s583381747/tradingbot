"""
EMA20 Trend Following — Gen 11: Dual Filter + Staircase Stop (no partial TP).
    ...
    def _manage(self):
        ...
        if near_ema and not self._in_pullback:
            ...
            if bounce and on_side:
                ...
                # Raise stop to new bounce low — staircase trail
                if d == 1:
                ...
                # NO partial TP — let 100% ride until stop hit
