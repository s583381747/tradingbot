"""Auto-generated backtrader strategy: 趋势跟随 (Trend Following) - 顺势20均线."""
...
class 趋势跟随TrendFollowing顺势20均线(BaseGeneratedStrategy):
    """Generated strategy: 趋势跟随 (Trend Following) - 顺势20均线.
