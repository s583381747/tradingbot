"""Auto-generated backtrader strategy: 趋势跟随策略 (Trend Following Strategy)."""
...
class 趋势跟随策略TrendFollowingStrategy(BaseGeneratedStrategy):
    """Generated strategy: 趋势跟随策略 (Trend Following Strategy).
